/* Formatted on 8/6/2025 11:20:03 AM (QP5 v5.422) */
--RUN SMR/FALL/SPR THEN JUST FALL WEEKLY - TUESDAYS

  SELECT SPRIDEN_ID                                    BID,
         ...
         T.RBRAPBC_AMT                                 TF_AMT,
         T.RBRAPBC_SYS_IND                             TF_SYS_IND,
         S.RBRAPBC_AMT                                 SURC_AMT,
         ...
         RNVAND0_BUDGET_AMOUNT                         YEAR_BUDGET,
         RNVAND0_UNMET_NEED                            YR_UNMET_NEED,
         ...
         (SELECT SUM (TBRACCD_AMOUNT)
           ...
           WHERE     TBRACCD_PIDM = RORSTAT_PIDM
                 ...
                 AND TBRACCD_DETAIL_CODE LIKE 'T%')    TUITION_CHRGES
    FROM RORSTAT
         LEFT JOIN SPRIDEN
