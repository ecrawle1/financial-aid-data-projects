...
SELECT DISTINCT BID,
                ...
                THEN 'Y' 
                END AS REVIEW_KC_OCOG,
                
                CASE WHEN KC_BILL_TOTAL >= NON_KC_BILL_TOTAL
                AND OCOG IN ('GSNOCE', 'GSN0CX','GSNOCR')
                THEN 'Y' 
                END AS REVIEW_RC_OCOG,
  ...
  FROM (SELECT DISTINCT NULL                          AS BID,
               NULL                          AS FNAME,
               NULL                          AS LNAME,
               SFRSTCA_TERM_CODE,
          ...
          FROM SFRSTCA
               ...
               JOIN RPRATRM P
                ...
                JOIN RPRATRM O
                      ...
                      AND O.RPRATRM_FUND_CODE IN ('GSNOCG', 'GSNO2E','GNOCE','GSNOCX', 'GSNOCR')
