...
SELECT DISTINCT
       ...
       RORHOLD_FROM_DATE,
       RORHOLD_TO_DATE,
       NULL AS RORHOLD_USER,
       RPRATRM_OFFER_AMT         PELL_OFFERED,
       RPRATRM_ACCEPT_AMT        PELL_ACCEPTED,
       RPRATRM_PAID_AMT          PELL_PAID,
       RORMESG_MESG_CODE,    
