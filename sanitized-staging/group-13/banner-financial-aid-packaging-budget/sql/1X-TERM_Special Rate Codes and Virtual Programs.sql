...
Select NULL AS STUDENT_ID, NULL AS STUDENT_FIRST_NAME, NULL AS STUDENT_LAST_NAME, RORSTAT_APRD_CODE APRD, SGBSTDN_TERM_CODE_EFF, SGBSTDN_STST_CODE, SGBSTDN_RATE_CODE COHORT, SGBSTDN_RESD_CODE RES,
