SELECT SPBPERS_SSN STUDENT_SSN, SPRIDEN_ID ID, SPRIDEN_LAST_NAME LNAME, SPRIDEN_FIRST_NAME, RCRAPP1_AIDY_CODE AIDY_CODE,
        A.SGBSTDN_SITE_CODE, RCRAPP1_CURR_REC_IND FAFSA, RCRAPP2_PELL_PGI EFC,
        RORSTAT_APRD_CODE APRD, A.RBRAPBG_PBGP_CODE SMR_BUDG,
        B.RBRAPBG_PBGP_CODE FAL_BUDG, C.RBRAPBG_PBGP_CODE SPR_BUDG, RORSTAT_PGRP_CODE PCKG_GRP, K.RRRAREQ_TREQ_CODE NSLDS_REQ, RRRAREQ_TRST_CODE NSLDS_STAT_CODE,
        ...
        D.RPRATRM_ACCEPT_AMT SMR_PELL_ACPT, D.RPRATRM_PAID_AMT SMR_PELL_PD,
        G.RPRATRM_ACCEPT_AMT SMR_SEOG_ACPT, G.RPRATRM_PAID_AMT SMR_SEOG_PD,
        E.RPRATRM_ACCEPT_AMT FAL_PELL_ACPT, E.RPRATRM_PAID_AMT FAL_PELL_PD,
        H.RPRATRM_ACCEPT_AMT FAL_SEOG_ACPT, H.RPRATRM_PAID_AMT FAL_SEOG_PD,
        F.RPRATRM_ACCEPT_AMT SPR_PELL_ACPT, F.RPRATRM_PAID_AMT SPR_PELL_PD,
        I.RPRATRM_ACCEPT_AMT SPR_SEOG_ACPT, I.RPRATRM_PAID_AMT SPR_SEOG_PD,
    ...
    and spriden_change_ind is null) BALANCE
        
        
FROM SGBSTDN A

LEFT JOIN SPRIDEN
ON          SPRIDEN_PIDM = A.SGBSTDN_PIDM
...
LEFT JOIN RRRAREQ K
ON K.RRRAREQ_PIDM = SPRIDEN_PIDM
AND K.RRRAREQ_TREQ_CODE in ('NSLDSA','NSLDSB','NSLDSD','NSLDSR','NSLDS','NSLDSG','NSLDSN','NSLDSP')
AND K.RRRAREQ_AIDY_CODE = :AIDY
